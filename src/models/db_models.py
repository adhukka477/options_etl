...
def make_option_model(ticker: str):
    ...
    class OptionContract(Base):
        ...
        option_type = Column(String(1), nullable=False, index=True)   # 'C' or 'P'
        ...
        veta = Column(Float, nullable=True)
        vomma = Column(Float, nullable=True)
        speed = Column(Float, nullable=True)
        zomma = Column(Float, nullable=True)
        color = Column(Float, nullable=True)
        ultima = Column(Float, nullable=True)
